...
def make_visual_pdf(athlete, cur, sessions, choice, photo_file=None):
    ...
    def donut(x,y,r,title,data,colorset=None):
        ...
        semantic = {
            "ACERTO": blue, "ERRO": red,
            "BOM": blue, "RUIM": lightblue, "EXCELENTE": red,
            "BAIXA": blue, "MEDIA": lightblue, "MÉDIA": lightblue, "ALTA": red,
            "BAIXO": blue, "MEDIO": lightblue, "MÉDIO": lightblue, "ALTO": red,
            "NORMAL": blue, "LENTO": lightblue, "RAPIDO": red, "RÁPIDO": red,
            "SWITCH": blue, "NOLLIE": lightblue, "FAKIE": red,
            "FRONTSIDE": blue, "BACKSIDE": lightblue, "REVERSE": red,
        }
        assigned=[]
